...
<div class="page page-center">
    <div class="container-tight py-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Agree the <a href="{{route('live.legal.terms-of-service')}}" tabindex="-1">terms and policy</a>.</span>
                    </label>
                </div>
        ...
        <div class="text-center text-muted mt-3">
            Already have account? <a href="{{route('live.authentication.sign')}}" tabindex="-1">Sign in</a>
        </div>
    </div>
</div>
<!-- Libs JS -->
